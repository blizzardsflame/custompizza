...
const Customize = ({ ingredients, setIngredients }) => {
  ...
  //Handlers
  const updateIngredients = (e, name) => {
      ...
      <div style={{ flex: 1, padding: 40 }}>
        <label className="container-checkbox">
          ...
          <input
            ...
            onChange={(event) =>
              updateIngredients(event.currentTarget.checked, "pineapple")
            }
          />
        ...
        <label className="container-checkbox">
          ...
          <input
            ...
            onChange={(event) =>
              updateIngredients(event.currentTarget.checked, "basil")
            }
          />
          <span className="checkmark"></span>
        </label>
        <label className="container-checkbox">
          ...
          <input
            ...
            onChange={(event) =>
              updateIngredients(event.currentTarget.checked, "olive")
            }
          />
          <span className="checkmark"></span>
        </label>
        <label className="container-checkbox">
          ...
          <input
            ...
            onChange={(event) =>
              updateIngredients(event.currentTarget.checked, "tomato")
            }
          />
          <span className="checkmark"></span>
        </label>
        <label className="container-checkbox">
          ...
          <input
            ...
            onChange={(event) =>
              updateIngredients(event.currentTarget.checked, "mushroom")
            }
          />
          <span className="checkmark"></span>
        </label>
        <label className="container-checkbox">
          ...
          <input
            ...
            onChange={(event) =>
              updateIngredients(event.currentTarget.checked, "cheese")
            }
          />
          <span className="checkmark"></span>
        </label>
